...
import { ROW, COLUMN, COMPONENT, DEFAULT_STYLES } from "./constants";
  ...
  switch (splitDropZonePath.length) {
    case 1: {
      newLayoutStructure = {
        type: ROW,
        id: shortid.generate(),
        children: [{ type: COLUMN, id: shortid.generate(), children: [item], object_properties: {style: DEFAULT_STYLES['column']} }],
        object_properties: {style: DEFAULT_STYLES['row']}
      };
      break;
    }
    case 2: {
      newLayoutStructure = {
        ...
        id: shortid.generate(),
        children: [item],
        object_properties: {style: DEFAULT_STYLES['column']}
      };
      break;
    }
    default: {
