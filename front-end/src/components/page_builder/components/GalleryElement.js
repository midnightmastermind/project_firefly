...
// const GalleryElement = ({ element, onAddItemType, onRemoveItem, onSaveConfiguration }) => {
...
// const GalleryElement = ({ setDraggable, element, onAddItemType, onRemoveItem, setLockGrid }) => {
...
const GalleryElement = memo(({ data, setDraggable, element, onAddItemType, onRemoveItem, setLockGrid }) => {
