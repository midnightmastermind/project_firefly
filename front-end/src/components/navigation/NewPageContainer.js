...
const PageContainer = (props) => {
    ...
    return (
        <div className={props.className} style={props.modal ? {backgroundColor: "transparent", position: "absolute", zIndex:"1005", minHeight: '900px', height: 'auto', width: '100%'} : {minHeight: '900px', height: 'auto', width: '100%'}}>
