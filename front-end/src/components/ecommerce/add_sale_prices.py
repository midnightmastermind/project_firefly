...
# Get a random sample of half of the documents
random_documents = random.sample(list(collection.find()), total_documents // 2)

# Loop through the random documents and add a random sale_price
